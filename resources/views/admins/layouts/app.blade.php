...
<html lang="en" class="light-style customizer-hide" dir="ltr" data-theme="theme-default"
    data-assets-path="/admins/assets/" data-template="vertical-menu-template-free">
...
<head>
    ...
    <title>@yield('title') | Infogence </title>
                    ...
                    <div class="card-body">
                        ...
                        <div class="app-brand justify-content-center">
                            <a href="{{url('/admin/dashboard')}}" class="app-brand-link gap-2">
                                ...
                                <span class="app-brand-text demo text-body fw-bolder">infogence</span>
                            </a>
                        </div>
