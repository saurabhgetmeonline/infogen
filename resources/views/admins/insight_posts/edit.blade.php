     ...
     <div class="container-xxl flex-grow-1 container-p-y">
         ...
         <div class="row">
             ...
             <div class="col-xxl">
                 <div class="card mb-4">
                     <div class="card-body">
                         <form action="{{url('insight-post/'.$insight_posts->insight_post_id )}}" method="post"
                             ...
                             <div class="row mb-3">
                                 ...
                                 <div class="col-sm-10">
                                     <input type="text" class="form-control" id="insight_post_id" name="insight_post_id"
                                         value="{{$insight_posts->insight_post_id}}" disabled />
                                 </div>
                             </div>
                             <div class="row mb-3">
                                 ...
                                 <div class="col-sm-10">
                                     ...
                                     <img src="/admins/assets/img/insights/thumbnail_image/{{$insight_posts->thumbnail_image}}"
                                         alt="{{$insight_posts->thumbnail_image}}" width="200" height="200">
                                 </div>
                             </div>
                             <div class="row mb-3">
                                 ...
                                 <div class="col-sm-10">
                                     ...
                                     <img src="/admins/assets/img/insights/featured_image/{{$insight_posts->featured_image}}"
                                         alt="{{$insight_posts->featured_image}}" width="200" height="200">
                                 </div>
                             </div>
                             <div class="row mb-3">
                             ...
                             <div class="row mb-3">
                                 ...
                                 <div class="col-sm-10">
                                     <input type="text" class="form-control" id="report_code" name="report_code"
                                         value="{{$insight_posts->report_code}}" />
                                 </div>
                             </div>
                             <div class="row mb-3">
                             ...
                             <div class="row mb-3">
                                 ...
                                 <div class="col-sm-10">
                                     <textarea id="sort_description" name="sort_description"
                                         class="form-control">{{$insight_posts->sort_description}}</textarea>
                                 </div>
                             </div>
                             <div class="row mb-3">
                                 ...
                                 <div class="col-sm-10">
                                     <input type="date" class="form-control" id="published_on" name="published_on"
                                         value="{{$insight_posts->published_on}}" />
                                 </div>
                             </div>
                            <div class="row mb-3">
                                 ...
                                 <div class="col-sm-10">
                                     <select id="category" name="category" class="form-select">
                                         ...
                                         <option value="{{$insight_category->insight_category_name}}"
                                             {{$insight_category->insight_category_name == $insight_posts->category ? 'selected' : ''}}>
                             ...
                             <div class="row mb-3">
                                 ...
                                 <div class="col-sm-10">
                                     <textarea id="editor" name="text"
                                         class="form-control">{!!$insight_posts->text !!}</textarea>
                                 </div>
                             </div>
                             <div class="row mb-3">
                                 ...
                                 <div class="col-sm-10">
                                     <input type="text" class="form-control" id="meta_title" name="meta_title"
                                         value="{{$insight_posts->meta_title}}" />
                                 </div>
                             </div>
                             <div class="row mb-3">
                                 ...
                                 <div class="col-sm-10">
                                     <textarea class="form-control" id="meta_description"
                                         name="meta_description">{{$insight_posts->meta_description}}</textarea>
                                 </div>
                             </div>
                             <div class="row mb-3">
                             ...
                             <div class="row mb-3">
                                 ...
                                 <div class="col-sm-10">
                                     <input type="text" class="form-control" id="meta_keywords" name="meta_keywords"
                                         value="{{$insight_posts->meta_keywords}}" />
                                 </div>
                             </div>
